...
@Slf4j
public class DeleteMultiInstanceExecutionOne extends AbstractCountersignCmd implements Command<String>, CountersigningVariables {
    /**
     * 当前任务ID
     */
    ...
    public DeleteMultiInstanceExecutionOne(String taskId, List<String> assigneeList) {
